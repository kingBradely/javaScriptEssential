...
function displayJavascriptEmployees() {
    ...
    const JavascriptEmployeesDisplay = JavascriptEmployees.map((employee, index) => `<p>${employee.id}: ${employee.name}: ${employee.name} - ${employee.department} - $${employee.salary}</p>`).join('');
